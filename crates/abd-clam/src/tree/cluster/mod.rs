...
/// - `parent_center_index`: The index of the center of the parent cluster. For the root cluster, this will be identical to `center_index`.
///
...
pub struct Cluster<T, A> {
    ...
    /// The index of the center of the parent cluster. For the root cluster, this will be identical to `center_index`.
    pub(crate) parent_center_index: usize,
}
