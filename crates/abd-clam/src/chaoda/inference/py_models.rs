...
type Ratios = [f32; crate::chaoda::NUM_RATIOS];

/// Returns the Python model with the given name.
pub fn get_py_model(name: &str) -> Result<fn(Ratios) -> f32, String> {
    match name {
        "lr_manhattan_sc" => Ok(lr_manhattan_sc),
        "lr_manhattan_cc" => Ok(lr_manhattan_cc),
        "lr_manhattan_gn" => Ok(lr_manhattan_gn),
        "lr_manhattan_cr" => Ok(lr_manhattan_cr),
        "lr_manhattan_sp" => Ok(lr_manhattan_sp),
        "lr_manhattan_vd" => Ok(lr_manhattan_vd),
        "lr_euclidean_cc" => Ok(lr_euclidean_cc),
        "lr_euclidean_sc" => Ok(lr_euclidean_sc),
        "lr_euclidean_gn" => Ok(lr_euclidean_gn),
        "lr_euclidean_cr" => Ok(lr_euclidean_cr),
        "lr_euclidean_sp" => Ok(lr_euclidean_sp),
        "lr_euclidean_vd" => Ok(lr_euclidean_vd),
        "dt_manhattan_cc" => Ok(dt_manhattan_cc),
        "dt_manhattan_sc" => Ok(dt_manhattan_sc),
        "dt_manhattan_gn" => Ok(dt_manhattan_gn),
        "dt_manhattan_cr" => Ok(dt_manhattan_cr),
        "dt_manhattan_sp" => Ok(dt_manhattan_sp),
        "dt_manhattan_vd" => Ok(dt_manhattan_vd),
        "dt_euclidean_cc" => Ok(dt_euclidean_cc),
        "dt_euclidean_sc" => Ok(dt_euclidean_sc),
        "dt_euclidean_gn" => Ok(dt_euclidean_gn),
        "dt_euclidean_cr" => Ok(dt_euclidean_cr),
        "dt_euclidean_sp" => Ok(dt_euclidean_sp),
        "dt_euclidean_vd" => Ok(dt_euclidean_vd),
        _ => Err(format!("Python model {name} not found")),
    }
}

fn lr_manhattan_cc(ratios: Ratios) -> f32 {
    let a = [
        1.228800e-01,
        1.227127e-01,
        7.808845e-02,
...
fn lr_manhattan_sc(ratios: Ratios) -> f32 {
    let a = [
        1.429870e-02,
        -1.323484e-02,
        -1.150261e-02,
...
fn lr_manhattan_gn(ratios: Ratios) -> f32 {
    let a = [
        8.262898e-03,
        1.537685e-02,
        9.422306e-03,
...
fn lr_manhattan_cr(ratios: Ratios) -> f32 {
    let a = [
        8.433946e-02,
        6.050625e-02,
        5.882554e-02,
...
fn lr_manhattan_sp(ratios: Ratios) -> f32 {
    let a = [
        4.659433e-02,
        -5.014006e-02,
        -6.017402e-02,
...
fn lr_manhattan_vd(ratios: Ratios) -> f32 {
    let a = [
        1.032663e-01,
        1.232432e-01,
        7.317461e-02,
...
fn lr_euclidean_cc(ratios: Ratios) -> f32 {
    let a = [
        1.313924e-01,
        1.326884e-01,
        9.136274e-02,
...
fn lr_euclidean_sc(ratios: Ratios) -> f32 {
    let a = [
        5.582536e-02,
        2.442987e-02,
        8.037801e-03,
...
fn lr_euclidean_gn(ratios: Ratios) -> f32 {
    let a = [
        9.585250e-02,
        6.025230e-02,
        3.753800e-02,
...
fn lr_euclidean_cr(ratios: Ratios) -> f32 {
    let a = [
        9.211533e-02,
        7.063269e-02,
        2.331588e-02,
...
fn lr_euclidean_sp(ratios: Ratios) -> f32 {
    let a = [
        8.131170e-02,
        1.629200e-02,
        -4.917042e-02,
...
fn lr_euclidean_vd(ratios: Ratios) -> f32 {
    let a = [
        1.096380e-01,
        1.658747e-01,
        1.045492e-01,
...
fn dt_manhattan_cc(ratios: Ratios) -> f32 {
...
fn dt_manhattan_sc(ratios: Ratios) -> f32 {
...
fn dt_manhattan_gn(ratios: Ratios) -> f32 {
...
fn dt_manhattan_cr(ratios: Ratios) -> f32 {
    let [cardinality, radius, _, cardinality_ema, _, lfd_ema] = ratios;
...
fn dt_manhattan_sp(ratios: Ratios) -> f32 {
...
fn dt_manhattan_vd(ratios: Ratios) -> f32 {
...
fn dt_euclidean_cc(ratios: Ratios) -> f32 {
...
fn dt_euclidean_sc(ratios: Ratios) -> f32 {
...
fn dt_euclidean_gn(ratios: Ratios) -> f32 {
...
fn dt_euclidean_cr(ratios: Ratios) -> f32 {
...
fn dt_euclidean_sp(ratios: Ratios) -> f32 {
...
fn dt_euclidean_vd(ratios: Ratios) -> f32 {
