...
fn simd_128_f32(c: &mut Criterion) {
    ...
    for d in 0..=3 {
        ...
        let id = BenchmarkId::new("Simd128L2Sq", dim);
        ...
        let id = BenchmarkId::new("Simd128L2", dim);
        group.bench_with_input(id, &dim, |b, _| {
            b.iter_with_large_drop(|| {
                data.iter()
                    .map(|x| {
...
fn simd_128_f64(c: &mut Criterion) {
...
criterion_group!(benches, simd_128_f32, simd_128_f64);
