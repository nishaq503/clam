...
fn simd_512_f32(c: &mut Criterion) {
    ...
    for d in 0..=3 {
        ...
        let id = BenchmarkId::new("Simd512L2Sq", dim);
        ...
        let id = BenchmarkId::new("Simd512L2", dim);
        group.bench_with_input(id, &dim, |b, _| {
            b.iter_with_large_drop(|| {
                data.iter()
                    .map(|x| {
...
fn simd_512_f64(c: &mut Criterion) {
...
criterion_group!(benches, simd_512_f32, simd_512_f64);
